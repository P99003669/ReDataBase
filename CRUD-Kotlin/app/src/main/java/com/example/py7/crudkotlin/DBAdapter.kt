...
class DBAdapter {
    ...
    private val databasetable = "studentinformation"
    private val collegeId = "Id"
    private val collegename = "Name"
    private val colJenis = "college"
    private val colHarga = "rollno"
    private val dbVersion = 1

    private val CREATE_TABLE_SQL = "CREATE TABLE IF TABLE NOT EXISTS " +
